...
- Enabling TBS is only needed for more aggressive scaling if a large backlog of change rows in a leaee table is a likely problem in terms of speedy processing
