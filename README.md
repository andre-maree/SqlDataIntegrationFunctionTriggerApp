...
Azure Functions app (.NET 8, isolated worker) that receives SQL Server data changes with the SQL Change Tracking/CDC feature enabled. The changed data is pushed to an Azure Function via the SqlTrigger function input binding.
